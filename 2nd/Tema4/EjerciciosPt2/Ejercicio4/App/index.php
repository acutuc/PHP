...
if(isset($_POST["btnContBorrar"]))
{
    ...
    //Creamos la respuesta de consumir_servicios_REST
    $respuesta = consumir_servicios_REST($url, "DELETE", [$_POST["btnContBorrar"]]);
    //Creamos el objeto
    $obj = json_decode($respuesta);

    //Vemos los distintos tipos de array que devuelve el objeto:
    if(isset($obj->error)){
        die(error_page("Práctica 1º CRUD", "<h1>Práctica 1º CRUD</h1><p>".$obj->error."</p>"));
    }
