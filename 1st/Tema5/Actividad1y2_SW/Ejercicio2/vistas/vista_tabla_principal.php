...
foreach($obj->productos as $tupla)
{
    ...
    echo "<td class='colorear'><form action='index.php' method='post'><button name='btnBorrar' class='enlace' value='".$tupla->cod."'>Borrar</button> - <button name='btnEditar' class='enlace' value='".$tupla->cod."'>Editar</button></form></td>";
    echo "</tr>";
}
echo "<table>";
?>