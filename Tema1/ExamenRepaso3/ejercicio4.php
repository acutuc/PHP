...
<body>
    ...
    <?php
        ...
        if (isset($_POST["btnVerHorario"])) {
            ...
            echo "<caption>Horario del gripo: <em>" . $_POST["grupo"] . "</em></caption>";
            ...
            for ($hora = 1; $hora <= 7; $hora++) {
                ...
                if ($hora == 4) {
                    ...
                    for ($dia = 1; $dia <= 5; $dia++) {
                        if(isset($horario[$grupo][$dia][$hora])){
                            echo "<td>".$horario[$grupo][$dia][$hora]."</td>";
                        }else{
                            echo "<td></td>";
                        }
